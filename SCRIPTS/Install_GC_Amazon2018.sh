...
rpm -i /tmp/gc-guest-agent-x86_64_Linux_Amazon_2018+.rpm
export CUSTOM_GC_ROOT=/custom_path
export GC_ROOT=/custom_path
export CUSTOM_GC_MAN_DIR=/custom_man_path
rpm -i /tmp/gc-guest-agent-x86_64_Linux_Amazon_2018+.rpm --relocate /var/lib/guardicore=/custom_path --relocate /usr/local/share/man=/custom_man_path
